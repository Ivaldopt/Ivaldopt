# Olá, eu sou Ivaldo Almeida 👋

![GIF de programação](https://media.giphy.com/media/VbnUQpnihPSIgIXuZv/giphy.gif)

Sou **designer e programador fullstack**, apaixonado por criar **produtos digitais modernos** e funcionais. 💻✨  
Atualmente, foco em **sites, e-commerces e aplicativos** do zero.
...
|---------|-----------|------|
| E-commerce do zero | E-commerce completo com dashboard, carrinho e Stripe | [Ver projeto](#) |
| App de passagens aéreas | Backend NestJS + PostgreSQL e frontend React Native | [Ver projeto](#) |
| Identidades visuais | Design de marcas, papelaria e produtos personalizados | [Ver projeto](#) |

---

## 📊 GitHub Stats

![Seu Nome GitHub stats](https://github-readme-stats.vercel.app/api?username=SEU_USERNAME&show_icons=true&theme=radical)
